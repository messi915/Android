package com.example.zeeshanaslam.fyp.runningService;
...
public class RunningServiceAdapter extends RecyclerView.Adapter<RunningServiceAdapter.ServiceViewHolder> {

    private  ArrayList<String> rupees;
    private ArrayList<String> data;
    private Context context;
    public RunningServiceAdapter(ArrayList<String> data, ArrayList<String> img, Context context)
    {
        this.data=data;
        rupees=img;
    ...
    public class ServiceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            Intent intent=new Intent(context,runningRequestDetail.class);
