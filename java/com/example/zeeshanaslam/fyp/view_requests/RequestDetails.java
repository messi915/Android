        ...
        kk.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren())
                {
                    ...
                    if(rupees.compareTo(request.price)==0 && title.compareTo(request.mainName)==0) {
            ...
            public void onClick(View v) {
                ...
                kk.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            Request request=dataSnapshot1.getValue(Request.class);
                            if(rupees.compareTo(request.price)==0 && title.compareTo(request.mainName)==0 && request.isStatus()==-1) {
