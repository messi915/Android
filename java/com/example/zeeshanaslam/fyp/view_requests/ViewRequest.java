...
import com.example.zeeshanaslam.fyp.Employee.EmployeeRequestedService;
        ...
        kk.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren())
                {
                    ...
                    if(uid.compareTo(request.uid)==0 && request.isStatus()==-1) {
                        name.add(request.mainName);
                        price.add(request.price);
                    }

                }
                RequestedService requestedService=new RequestedService(name,price,getApplicationContext());
