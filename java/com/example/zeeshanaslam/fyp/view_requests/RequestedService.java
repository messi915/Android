...
import com.example.zeeshanaslam.fyp.CardDisplay;
import com.example.zeeshanaslam.fyp.R;

import java.util.ArrayList;

public class RequestedService extends RecyclerView.Adapter<RequestedService.ServiceViewHolder> {

    private  ArrayList<String> rupees;
    private ArrayList<String> data;
    private Context context;
    public RequestedService(ArrayList<String> data,ArrayList<String> img, Context context)
    {
        this.data=data;
        rupees=img;
