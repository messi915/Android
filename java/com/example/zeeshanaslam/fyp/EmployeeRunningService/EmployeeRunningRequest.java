...
import com.example.zeeshanaslam.fyp.Employee.Employee_DisplayProfileData;
import com.example.zeeshanaslam.fyp.Employee.Employee_Main_Activity;
import com.example.zeeshanaslam.fyp.Employee.Employee_ViewRequest;
import com.example.zeeshanaslam.fyp.MainActivity;
import com.example.zeeshanaslam.fyp.R;
import com.example.zeeshanaslam.fyp.runningService.RunningServiceAdapter;
...
public class EmployeeRunningRequest extends AppCompatActivity
        ...
        kk.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren())
                {
                    ...
                    if(uid.compareTo(request.getEmployeeID())==0 ) {
                        name.add(request.getName());
                        price.add(request.getPrice());
                    }

                }
                mDialog.dismiss();
                EmployeeRunningServiceAdapter requestedService=new EmployeeRunningServiceAdapter(name,price,getApplicationContext());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent i=new Intent(getApplicationContext(),Employee_ViewRequest.class);
            startActivity(i);
