...
import com.example.zeeshanaslam.fyp.runningService.runningRequestDetail;

import java.util.ArrayList;

public class EmployeeRunningServiceAdapter extends RecyclerView.Adapter<EmployeeRunningServiceAdapter.ServiceViewHolder> {

    private  ArrayList<String> rupees;
    private ArrayList<String> data;
    private Context context;
    public EmployeeRunningServiceAdapter(ArrayList<String> data, ArrayList<String> img, Context context)
    {
        this.data=data;
        rupees=img;
    ...
    public class ServiceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            Intent intent=new Intent(context,EmployeerunningRequestDetail.class);
